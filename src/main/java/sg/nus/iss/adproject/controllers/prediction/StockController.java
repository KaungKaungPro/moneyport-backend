...
import sg.nus.iss.adproject.dto.prediction.PredictionRequest;
import sg.nus.iss.adproject.dto.prediction.PredictionResult;
import sg.nus.iss.adproject.dto.prediction.StockData;
import sg.nus.iss.adproject.services.prediction.PredictionService;
import sg.nus.iss.adproject.services.prediction.StockService;
...
public class StockController {
	...
	public ResponseEntity<?> predictStock(@RequestBody PredictionRequest request) {
		...
		try {
			PredictionResult prediction = predictionService.predict(request.getSymbol(), request.getDate(),
